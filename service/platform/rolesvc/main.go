...
import (
	...
	"github.com/galaxy-book/polaris-backend/service/platform/rolesvc/api"
...
func main() {
	...
	fmt.Println("运行init后的常量值", sconsts.CacheRoleList, sconsts.CacheRolePermissionOperationList, sconsts.CacheUserRoleListHash)
	r := gin.New()
