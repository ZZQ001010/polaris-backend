...
import (
	...
	"github.com/galaxy-book/polaris-backend/service/platform/orgsvc/api"
	"github.com/galaxy-book/polaris-backend/service/platform/orgsvc/consume"
...
func main() {
	...
	log.Info("mysql config: " + strs.ObjectToString(config.GetMysqlConfig()))
