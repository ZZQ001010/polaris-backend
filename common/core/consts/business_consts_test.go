...
//公用项目
func TestConstProjectIsFilling(t *testing.T) {

	convey.Convey("Test ProjectIsFilling", t, func() {

		convey.Convey("ProjectIsFilling", func() {
			convey.So(ProjectIsFilling, convey.ShouldEqual, 1)
		})

		convey.Convey("ProjectIsNotFilling", func() {
			convey.So(ProjectIsNotFilling, convey.ShouldEqual, 2)
		})
	})
}
